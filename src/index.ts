...
class GitChanges {
    ...
    public async main() {
        ...
        this.saveFile(finalFormatedFiles, 'Arquivos alterados (organizados por commits)');
        this.saveFile(this.plataformaService.listFilesByProjectByCategories(finalFormatedFiles), 'Arquivos alterados (organizados por projeto)')
    }
...
new GitChanges(new BaseService(), new PlataformaService()).main();
